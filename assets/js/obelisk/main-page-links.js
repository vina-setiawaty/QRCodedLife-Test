/* ==========================================================================
   main-page-links.js — Prototype 3 bootstrap.

   Same scene as Prototype 1, but only the 3 QR codes in `pageRoutes` are
   live (the rest are dimmed + inert). Tapping a live QR code is a plain
   navigation to its own page (.../page-N/) rather than opening a modal.
   ========================================================================== */
